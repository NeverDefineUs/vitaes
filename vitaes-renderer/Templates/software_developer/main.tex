...
\section{$resources['education']}
  #for $education in $education_array
    ...
    {$format_datetime($education['start_date'], 'LLL, YYYY', locale=$params['lang']) 
      ...
      {$break_into_items($education['description'], header="\\resumeItemListStart", bottom="\\resumeItemListEnd", itemPrefix="\\resumeItem{", itemSuffix="}")}
    #else
      {}
    #end if
  #end for
...
\section{$resources['experience']}
  #for $work in $work_array
    ...
    {$format_datetime($work['start_date'], 'LLL, YYYY', locale=$params['lang']) 
      ...
      {$break_into_items($work['description'], header="\\resumeItemListStart", bottom="\\resumeItemListEnd", itemPrefix="\\resumeItem{", itemSuffix="}")}
    #else
      {}
    #end if
  #end for
...
\section{$resources['projects']}
  #for $project in $project_array
    ...
    {$format_datetime($project['start_date'], 'LLL, YYYY', locale=$params['lang']) 
      ...
      {$break_into_items($project['description'], header="\\resumeItemListStart", bottom="\\resumeItemListEnd", itemPrefix="\\resumeItem{", itemSuffix="}")}
    #else
      {}
    #end if
  #end for
...
\section{$resources['academicXp']}
  #for $academic in $academic_array
    ...
    {$format_datetime($academic['start_date'], 'LLL, YYYY', locale=$params['lang']) 
      ...
      {$break_into_items($academic['description'], header="\\resumeItemListStart", bottom="\\resumeItemListEnd", itemPrefix="\\resumeItem{", itemSuffix="}")}
    #else
      {}
    #end if
  #end for
