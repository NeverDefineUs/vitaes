...
import { isEnumType, isInputObjectType, isInterfaceType, isListType, isNonNullType, isObjectType, isScalarType, isSpecifiedScalarType, isUnionType, } from "graphql";
...
export class TypegenPrinter {
    ...
    printDynamicImport() {
        ...
        const nexusSchemaImportId = (_a = this.typegenInfo.nexusSchemaImportId, (_a !== null && _a !== void 0 ? _a : getOwnPackage().name));
