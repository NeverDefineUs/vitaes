    ...
    render() {
      ...
      return (
        <div className="Base">
          ...
          <CvHeaderField stateChanger={this.handleChangeHeader} curriculum={this.props.cv} label="email" mandatory={false} placeholder="Full email address"/>
