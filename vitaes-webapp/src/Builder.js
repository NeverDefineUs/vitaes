...
class Builder extends Component {
  ...
  downloadCvAsJson() {
    ...
    var file = new Blob([JSON.stringify(this.props.cv)], {
      type: 'text/plain'
    });
  ...
  render() {
    ...
    if (this.props.cv_models[this.state.user_cv_model] !== undefined) {
      for (let cv_suboption of this.props.cv_models[this.state.user_cv_model][
        'params'
      ]) {
        ...
        cv_model_suboptions = cv_model_suboptions.concat([
          <br />,
          <br />,
          <div className="Base-label">{cv_suboption['pretty_name']}:</div>,
          <select
